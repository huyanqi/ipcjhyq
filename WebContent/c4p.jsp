...
<script type="text/javascript">
	...
	function match(){
		...
		//出发省份name
		var fromProvinceName = $("#select-native-1").find("option:selected").text();
		//出发城市ID
		...
		//出发地区name
		var fromDistrictName = $("#select-native-3").find("option:selected").text();
		//出发详细地址
		...
		//到达省份name
		var toProvinceName = $("#select-native-4").find("option:selected").text();
		//到达城市ID
		...
		//到达地区name
		var toDistrictName = $("#select-native-6").find("option:selected").text();
		//到达详细地址
...
<header class="am-topbar">
	...
	<table style="width: 100%; margin-top: 20px;"
		...
		<tr>
			<td>汽车型号：</td>
			<td colspan="3"><input id="car" type="text" class="am-form-field"/></td>
		</tr>
		<tr>
			<td>&emsp;空位数：</td>
		...
		<tr>
			<td>联系人名:</td>
			<td colspan="3"><input type="text" id="name" class="am-form-field"/></td>
		</tr>
		<tr>
			<td>联系电话:</td>
			<td colspan="3"><input type="number" id="mobile" class="am-form-field" onkeypress="return noNumbers(event)"/></td>
		</tr>
	</table>
